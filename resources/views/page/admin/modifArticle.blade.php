...
@php
    ...
    switch ($typeArticle) {
        case "Evenement 2015" : 
            $titre = "Modification d'un évènements 2015"; 
            break;
...
<br />
@endif
<img src='{{$path['image']}}{{$imgArticle}}' name="imageArticle" id="imageArticle">
@php
    $image = "";
    switch ($typeArticle) {
        case "Evenement 2015" : 
...
<form id="form" method="post" action="{{ $modifArticleUrl }}" onsubmit="go()">
    {{ csrf_field() }}
    @php
        $titre = "";
        switch ($typeArticle) {
